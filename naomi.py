...
sub_client = amino.SubClient(comId='AnyWorld657', profile=client.profile) #вместо "id" введите айди сообщества, в котором будет работать чат
ban = 0
tim = 1
hm = [0]
av = []
...
def on_message(data):
	...
	if content[0][0] == "!":
	 ...
	 if ANTI_SPAM.get(userid) is Darki:
